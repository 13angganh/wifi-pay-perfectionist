  ...
  return (
    <>
      ...
      <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:8, marginBottom:8 }}>
        ...
        <div style={{ background:'var(--bg2)', border:'1px solid var(--border)', borderRadius:'var(--r-md)', padding:12, boxShadow:'var(--shadow-xs)' }}>
          <div style={{ fontSize:'var(--fs-micro)', color:'var(--txt3)', letterSpacing:'.06em', marginBottom:4, fontFamily:"var(--font-sans),sans-serif" }}>{t('grafik.vsLastYear').toUpperCase()}<PctBadge pct={curYPct} /></div>
